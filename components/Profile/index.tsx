...
const Profile = () => {
  const texts = ["WebApps", "AIProjects",];
    ...
    <div className="flex flex-col overflow-hidden size-full relative z-10 p-5 items-start justify-start gap-8 max-sm:h-[275px] max-sm:gap-4 dark:text-dark-4 text-white border border-dark-3 dark:border-0 rounded-xl dark:bg-[#FDFDFD]">
      <div className="w-full flex justify-between items-start">
        <div className="flex gap-3">
          ...
          />
          <div className="">
            <p className="font-bold text-lg">Deehan.</p>
            <p className="text-md font-mono dark:text-black/70 text-zinc-400/80">@DeehanPaul123</p>
          </div>
        </div>
        <ThemeToggler />
      </div>
      <div className="flex flex-col gap-1 overflow-hidden ">
        ...
        <div className="w-full">
          <p className="text-sm">
            Hello, I’m Deehan, I'm a 20 year old developer based in Bhubaneshwar - India.
          </p>
        </div>
      </div>
      ...
      <div className="absolute bottom-5 left-5 max-sm:hidden">
        <div className="w-full">
          <p className="text-xs font-mono dark:text-black/70 text-zinc-400/70">
            &ldquo;How do i train <br /> a machine learning model again??&quot;
          </p>
        </div>
      </div>
    </div>
